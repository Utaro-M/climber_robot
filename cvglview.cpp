		 ...
		 CvMat* rotation, CvMat* translation )
{
    ...
    cvFindExtrinsicCameraParams2( objectPoints, cornerPoints,   //オブジェクトの点の配列．3xNまたはNx3でNはビューにおける点の数．
				  intrinsic, distortion,
				  rotVector, translation );//rotation_vector を作成　出力される3x1 または 1x3の回転ベクトル（コンパク トな回転行列の表記についてはcvRodrigues2 を参照）．
    cvRodrigues2( rotVector, rotation, 0 ); //rotvectorからrotation行列を作成
